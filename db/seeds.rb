...
Retailer.create("name"=>"Sally Beauty Supply")
Retailer.create("name"=>"Sephora")
Retailer.create("name"=>"Ulta")
Retailer.create("name"=>"CVS")
Retailer.create("name"=>"Elegant Beauty Supply")
Retailer.create("name"=>"Macys")
Retailer.create("name"=>"Walmart")

# Rebate.create(product_id: , retailer_id: 1, amount: 1)
# Rebate.create(product_id: , retailer_id: 2, amount: 2)
# Rebate.create(product_id: , retailer_id: 3, amount: 3)
# Rebate.create(product_id: , retailer_id: 4, amount: 4)
# Rebate.create(product_id: , retailer_id: 5, amount: 5)
# Rebate.create(product_id: , retailer_id: 6, amount: 6)
# Rebate.create(product_id: , retailer_id: 2, amount: 7)
# Rebate.create(product_id: , retailer_id: 1, amount: 8)
# Rebate.create(product_id: , retailer_id: 2, amount: 9)
# Rebate.create(product_id: , retailer_id: 3, amount: 10)
# Rebate.create(product_id: , retailer_id: 6, amount: 11)
# Rebate.create(product_id: , retailer_id: 2, amount: 12)
# Rebate.create(product_id: , retailer_id: 3, amount: 13)
# Rebate.create(product_id: , retailer_id: 6, amount: 14)
